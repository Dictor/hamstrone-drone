...
/* ./.libs/lt-mconf.c - temporary wrapper executable for .libs/mconf
   Generated by libtool (GNU libtool) 2.4.6

   The mconf program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "/cygdrive/e/hamstrone/nuttx/os/tools/kconfig-frontends-3.12.0.0/libs/parser/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/cygdrive/e/hamstrone/nuttx/os/tools/kconfig-frontends-3.12.0.0/libs/parser/.libs:/usr/local/lib:/usr/local/bin:";
const char * TARGET_PROGRAM_NAME = "mconf"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# mconf - temporary wrapper script for .libs/mconf\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The mconf program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../../libs/parser/libkconfig-parser.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"mconf:mconf:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"mconf:mconf:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"mconf:mconf:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("    PATH=/cygdrive/e/hamstrone/nuttx/os/tools/kconfig-frontends-3.12.0.0/libs/p", f);
  fputs ("arser/.libs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/cygdrive/e/hamstrone/nuttx/os/tools/kconfig-frontends-3.12.0.0/libs/", f);
  fputs ("parser/.libs:$PATH\"\n", f);
  fputs ("\n", f);
